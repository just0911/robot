...
在实际创建 ApplicationSet 对象之前，我们先来看一下 [示例仓库](https://github.com/lyzhang1999/kubernetes-example)。你需要注意的是，这节课所需要用到的示例应用在 helm-env 目录下。
...
![图片](images/627994/d01250f01e623e91e0a5db1cb68a23ac.jpg)
